...
const ContactSection = () => (
  <section id="contact" className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 to-pink-50 overflow-hidden">
    {/* Grid Background */}
    <div 
      ...
      <div className="text-center">
        ...
        <div className="mb-12">
          <a 
            ...
            className="inline-flex items-center px-8 py-4 text-white text-lg font-medium rounded-full transition-all transform hover:scale-105 hover:shadow-lg"
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a 
              href={SOCIAL_LINKS.CV_DOWNLOAD} 
              download="CV-Lea-Mathieu.pdf"
              className="w-16 h-16 rounded-2xl flex items-center justify-center transition-transform hover:scale-110"
        ...
        <div className="absolute bottom-8 right-8">
          <div className="text-right">
            ...
            <div className="inline-block mt-2">
              <svg viewBox="0 0 24 24" className="w-8 h-8" fill={COLORS.PRIMARY}>
