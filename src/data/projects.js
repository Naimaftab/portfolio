export const projects = [
  {
    ...
    objectives: [
      "Créer une interface moderne et attrayante pour la vente de plantes",
      "Optimiser l'expérience utilisateur du parcours d'achat",
  ...
  },
  {
    ...
    objectives: [
      "Concevoir une expérience utilisateur apaisante et intuitive",
      "Créer un système de motivation et de suivi des progrès",
  ...
  },
  {
    ...
    objectives: [
      "Simplifier la gestion de projets créatifs complexes",
      "Optimiser la collaboration entre équipes distantes",
